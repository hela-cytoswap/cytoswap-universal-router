...
import {SafeCast} from '@cytoswap/v3-core/contracts/libraries/SafeCast.sol';
import {ICytoswapV3Pool} from '@cytoswap/v3-core/contracts/interfaces/ICytoswapV3Pool.sol';
import {ICytoswapV3SwapCallback} from '@cytoswap/v3-core/contracts/interfaces/callback/ICytoswapV3SwapCallback.sol';
...
/// @title Router for Cytoswap v3 Trades
abstract contract V3SwapRouter is CytoswapImmutables, Permit2Payments, ICytoswapV3SwapCallback {
    ...
    function cytoswapV3SwapCallback(int256 amount0Delta, int256 amount1Delta, bytes calldata data) external {
    ...
    /// @notice Performs a Cytoswap v3 exact input swap
    ...
    /// @notice Performs a Cytoswap v3 exact output swap
    /// @param recipient The recipient of the output tokens
        ...
        returns (int256 amount0Delta, int256 amount1Delta, bool zeroForOne)
    {
        ...
        (amount0Delta, amount1Delta) = ICytoswapV3Pool(computePoolAddress(tokenIn, tokenOut, fee)).swap(
            recipient,
            zeroForOne,
            amount,
                ...
                uint256(
                    keccak256(
                        abi.encodePacked(
                            ...
                            CYTOSWAP_V3_POOL_INIT_CODE_HASH
                        )
                    )
                )
            )
