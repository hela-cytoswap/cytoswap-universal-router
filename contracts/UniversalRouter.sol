...
import {CytoswapImmutables, CytoswapParameters} from './modules/cytoswap/CytoswapImmutables.sol';
...
contract UniversalRouter is IUniversalRouter, Dispatcher, RewardsCollector {
    ...
    constructor(RouterParameters memory params)
        CytoswapImmutables(
            CytoswapParameters(params.v2Factory, params.v3Factory, params.pairInitCodeHash, params.poolInitCodeHash)
        )
